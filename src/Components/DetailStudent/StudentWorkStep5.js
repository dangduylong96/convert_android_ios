...
import apiPostWorkProfile from '../../Api/apiPostWorkProfile';
...
class StudentWorkStep5 extends Component{
	constructor(props){
		super(props);
		this.state={
			numberAccountBank: '',
	...
	saveStudentWorkStep5 = async () => {
        try {
            ...
            let bodyData={
        		...
        		//Thông tin công ty
        		'nameCompany': StudentWorkStep3.nameCompany,
        		'level': StudentWorkStep3.level,
        		'salaryMonth': StudentWorkStep3.salaryMonth,
        		'phoneCompany': StudentWorkStep3.phoneCompany,
        		'sourceHdld': StudentWorkStep3.sourceHdld,
	...
	render(){
		const { numberAccountBank, nameBank, urlBeforeBank, isSubmit, textBtnLogin}=this.state;
		return(
...
export default connect()(StudentWorkStep5)
